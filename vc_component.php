...
function vc_exhibitors_list() {
  vc_map( array(
	...
	if ( $the_query->have_posts() ) {
		...
		$show_me_company2 = ($show_company == 'false') ? "" :  "<option class='sort-option'>Firma</option>";
		$show_me_stand2 = ($show_stand == 'false') ? "" : "<option class='sort-option'>Stoisko</option>";
		$show_me_email2 = ($show_email == 'false') ? "" : "<option class='sort-option'>Email</option>";
		$show_me_website2 = ($show_website == 'false') ? "" : "<option class='sort-option'>Strona</option>";
		$show_me_hall2 = ($show_hall == 'false') ? "" : "<option class='sort-option'>Hala</option>";
		$show_me_phone2 = ($show_phone == 'false') ? "" : "<option class='sort-option'>Telefon</option>";
		$show_me_excerpt2 = ($show_excerpt == 'false') ? "" : "<option class='sort-option'>Opis</option>";
		$select = "<div class='box'><div class='sorting-box'><select id='sorting'><option value='' selected disabled hidden>Sortuj według</option>" . $show_me_company2 . $show_me_stand2 . $show_me_email2 . $show_me_website2 . $show_me_hall2 . $show_me_phone2 . $show_me_excerpt2 . "</select></div><div class='searching-box'><input id='search-bar' type='text' placeholder='Szukaj'></input></div></div>";
		// PRINT OUTPUT
